...
AI_PLAYGROUND_HF_HAIRFASTGAN_ENABLED = os.getenv(
    "AI_PLAYGROUND_HF_HAIRFASTGAN_ENABLED",
    "0",
) == "1"
AI_PLAYGROUND_HF_HAIRFASTGAN_SPACE = os.getenv(
    "AI_PLAYGROUND_HF_HAIRFASTGAN_SPACE",
    "AIRI-Institute/HairFastGAN",
).strip()
AI_PLAYGROUND_HF_HAIRFASTGAN_TOKEN = os.getenv(
    "AI_PLAYGROUND_HF_HAIRFASTGAN_TOKEN",
    "",
).strip()
AI_PLAYGROUND_HF_HAIRFASTGAN_ALIGN = os.getenv(
    "AI_PLAYGROUND_HF_HAIRFASTGAN_ALIGN",
    "Face,Shape,Color",
).strip()
AI_PLAYGROUND_HF_HAIRFASTGAN_BLENDING = os.getenv(
    "AI_PLAYGROUND_HF_HAIRFASTGAN_BLENDING",
    "Article",
).strip()
AI_PLAYGROUND_HF_HAIRFASTGAN_POISSON_ITERS = os.getenv(
    "AI_PLAYGROUND_HF_HAIRFASTGAN_POISSON_ITERS",
    "0",
).strip()
AI_PLAYGROUND_HF_HAIRFASTGAN_POISSON_EROSION = os.getenv(
    "AI_PLAYGROUND_HF_HAIRFASTGAN_POISSON_EROSION",
    "15",
).strip()
AI_PLAYGROUND_HF_HAIRFASTGAN_SWAP_MAX_RETRIES = int(
    os.getenv("AI_PLAYGROUND_HF_HAIRFASTGAN_SWAP_MAX_RETRIES", "3")
)
AI_PLAYGROUND_REPLICATE_HAIRCLIP_ENABLED = os.getenv(
    "AI_PLAYGROUND_REPLICATE_HAIRCLIP_ENABLED",
    "0",
) == "1"
AI_PLAYGROUND_REPLICATE_API_TOKEN = os.getenv(
    "AI_PLAYGROUND_REPLICATE_API_TOKEN",
    "",
).strip()
AI_PLAYGROUND_REPLICATE_API_BASE = os.getenv(
    "AI_PLAYGROUND_REPLICATE_API_BASE",
    "https://api.replicate.com/v1",
).strip()
AI_PLAYGROUND_REPLICATE_HAIRCLIP_MODEL_VERSION = os.getenv(
    "AI_PLAYGROUND_REPLICATE_HAIRCLIP_MODEL_VERSION",
    "b95cb2a16763bea87ed7ed851d5a3ab2f4655e94bcfb871edba029d4814fa587",
).strip()
AI_PLAYGROUND_REPLICATE_HAIRCLIP_FALLBACK_HAIRSTYLE = os.getenv(
    "AI_PLAYGROUND_REPLICATE_HAIRCLIP_FALLBACK_HAIRSTYLE",
    "short hair hairstyle",
).strip()
AI_PLAYGROUND_REPLICATE_HAIRCLIP_WAIT_SECONDS = int(
    os.getenv("AI_PLAYGROUND_REPLICATE_HAIRCLIP_WAIT_SECONDS", "60")
)
AI_PLAYGROUND_REPLICATE_HAIRCLIP_POLL_INTERVAL_SECONDS = os.getenv(
    "AI_PLAYGROUND_REPLICATE_HAIRCLIP_POLL_INTERVAL_SECONDS",
    "2",
).strip()
AI_PLAYGROUND_REPLICATE_HAIRCLIP_MAX_IMAGE_SIDE = int(
    os.getenv("AI_PLAYGROUND_REPLICATE_HAIRCLIP_MAX_IMAGE_SIDE", "1024")
)
AI_PLAYGROUND_REPLICATE_HAIRCLIP_JPEG_QUALITY = int(
    os.getenv("AI_PLAYGROUND_REPLICATE_HAIRCLIP_JPEG_QUALITY", "90")
)
...
AI_PLAYGROUND_NANOBANANA_IMAGE_SIZE = os.getenv("AI_PLAYGROUND_NANOBANANA_IMAGE_SIZE", "")
AI_PLAYGROUND_NANOBANANA_PROMPT_SET = os.getenv("AI_PLAYGROUND_NANOBANANA_PROMPT_SET", "1")
AI_PLAYGROUND_NANOBANANA_FLASH_PROMPT_SET = os.getenv("AI_PLAYGROUND_NANOBANANA_FLASH_PROMPT_SET", "")
AI_PLAYGROUND_NANOBANANA_PRO_PROMPT_SET = os.getenv("AI_PLAYGROUND_NANOBANANA_PRO_PROMPT_SET", "")
